      ...
      <section className="mx-auto max-w-7xl px-5 py-16 md:py-24">
        ...
        <div className="mt-12 grid auto-rows-[16rem] gap-5 md:grid-cols-3">
          {galleryItems.map((item, index) => (
            <article key={item.title} className={`group relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-flame/50 via-smoke to-black p-6 shadow-warm ${item.size}`}>
